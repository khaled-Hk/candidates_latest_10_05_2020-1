...
export default {
    ...
    methods: {
        async GetCandidateIdByNid() {
            const candidate = await this.$http.GetCandidateIdByNid(this.ruleForm.nationalId);
            this.$parent.candidateId = candidate.data.candidateId;
