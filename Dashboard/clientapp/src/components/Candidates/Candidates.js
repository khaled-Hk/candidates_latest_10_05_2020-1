    ...
    <div class="">
      ...
      <div class="content">
        ...
        <div class="item-1">
          ...
          <div class="input">${object.createdOn}</div>
        </div>
        <!-- End Item -->
        ...
        <div class="item-2">
          ...
          <div class="input">${object.name}</div>
        </div>
        <!-- End Item -->
        ...
        <div class="item-2">
          ...
          <div class="input">${object.nid}</div>
        </div>
        <!-- End Item -->
        ...
        <div class="item-2">
          ...
          <div class="input">${object.constituencyName}</div>
        </div>
        <!-- End Item -->
        ...
        <div class="item-2">
          ...
          <div class="input">${object.subconstituencyName}</div>
        </div>
        <!-- End Item -->
        ...
        <div class="item-2">
          ...
          <div class="input">${object.officaeName}</div>
        </div>
        <!-- End Item -->
        ...
        <div class="item-2">
          ...
          <div class="input">${object.candidateId}</div>
        </div>
        <!-- End Item -->
      </div>
      <!-- End Content -->
      ...
      <!-- Footer  -->
      <div class="footer">
        <div class="em-number">موظف التسجيل: ${object.officeUserId}</div>
      </div>
      <!-- End Footer  -->
    </div>
    <!-- End Form One -->
